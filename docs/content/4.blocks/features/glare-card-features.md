---
title: Glare Card Features
description: Feature section using the GlareCard component with hover effects.
navigation:
...
Feature section using the GlareCard component with hover effects to create an eye-catching presentation of product features.
...
---
  :::div{class="flex justify-center w-full h-full"}
    <component-example name="glare-card-features" />
  :::
#code
```vue
<template>
