---
title: Text Loop Alignment
description: Examples showing proper text alignment with the TextLoop component.
navigation:
...
---
  :::div{class="p-4"}
    <component-example name="text-loop-alignment-test" />
  :::
#code
```vue
<template>
