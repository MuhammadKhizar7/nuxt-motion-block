...
description: A modern creative agency landing page template with portfolio showcases, team highlights, and conversion-focused design.
navigation:
...
---
  :::div{class="w-full h-full"}
    <component-example name="CreativeAgencyLandingPage" />
  :::
#code
```vue
<template>
