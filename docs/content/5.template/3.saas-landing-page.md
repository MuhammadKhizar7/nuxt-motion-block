...
description: A modern SaaS landing page template with animated sections, feature highlights, and conversion-focused design.
navigation:
...
---
  :::div{class="w-full h-full"}
    <component-example name="SaaSLandingPage" />
  :::
#code
```vue
<template>
