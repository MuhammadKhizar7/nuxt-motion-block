          ...
          <div class="flex items-center justify-between">
            ...
            <div class="p-3 rounded-full bg-green-100 dark:bg-green-900/30">
              <UIcon
                ...
                class="w-6 h-6 text-green-600 dark:text-green-400 flex justify-center items-center"
              />
            </div>
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="p-3 rounded-full bg-blue-100 dark:bg-blue-900/30">
              <UIcon
                ...
                class="w-6 h-6 text-blue-600 dark:text-blue-400 flex justify-center items-center"
              />
            </div>
          </div>
          <div class="mt-4 flex items-center text-sm">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="p-3 rounded-full bg-amber-100 dark:bg-amber-900/30">
              <UIcon
                ...
                class="w-6 h-6 text-amber-600 dark:text-amber-400 flex justify-center items-center"
              />
            </div>
          </div>
          <div class="mt-4 flex items-center text-sm">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="p-3 rounded-full bg-purple-100 dark:bg-purple-900/30">
              <UIcon
                ...
                class="w-6 h-6 text-purple-600 dark:text-purple-400 flex justify-center items-center"
              />
            </div>
          </div>
          <div class="mt-4 flex items-center text-sm">
