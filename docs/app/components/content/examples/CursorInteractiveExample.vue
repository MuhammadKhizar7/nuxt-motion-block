<template>
  <div class="min-h-screen p-8">
    <!-- Global Cursor -->
    <MCursor v-if="!attachToParent" :spring-config="springConfig">
    ...
    <div class="max-w-4xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        >
          <MCursor v-if="attachToParent && activeContainer === 'blue'" :attach-to-parent="true" :spring-config="springConfig">
            <div class="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center">
              <div class="w-2 h-2 rounded-full"></div>
            </div>
          </MCursor>
          <h3 class="text-xl font-semibold mb-2">Blue Container</h3>
        ...
        <div 
          ...
          @mouseout="activeContainer = ''"
        >
          <MCursor v-if="attachToParent && activeContainer === 'red'" :attach-to-parent="true" :spring-config="springConfig">
            <div class="w-8 h-8 rounded-full bg-red-500 flex items-center justify-center">
              <div class="w-2 h-2 rounded-full"></div>
            </div>
          </MCursor>
          <h3 class="text-xl font-semibold mb-2">Red Container</h3>
          <p>Custom cursor appears only in this area</p>
        </div>
      </div>
      ...
      <div class="p-6 rounded-xl">
        ...
        <div class="space-y-4">
          <UFormField label="Cursor Mode" name="cursorMode">
            <URadioGroup 
          ...
          <UFormField label="Spring Stiffness" name="stiffness">
            <USlider 
          ...
          <UFormField label="Spring Damping" name="damping">
            <USlider 
