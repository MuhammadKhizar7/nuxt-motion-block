    ...
    <div class="max-w-4xl mx-auto">
      <div class="text-center mb-12">
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Discover our premium collection with interactive 3D cards
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="text-center space-y-4 p-6">
            ...
            <h3 class="text-2xl font-bold text-white">Lightning Fast</h3>
            <p class="text-slate-400">
              Experience blazing performance with our optimized solution
            </p>
            <div class="mt-4">
              <UButton color="primary" size="sm">Learn More</UButton>
            </div>
          </div>
        </MGlareCard>
        ...
        >
          <div class="text-center space-y-4 p-6">
            ...
            <h3 class="text-2xl font-bold text-white">Beautiful Effects</h3>
            <p class="text-slate-400">
        ...
        >
          <div class="text-center space-y-4 p-6">
            ...
            <h3 class="text-2xl font-bold text-white">Easy Integration</h3>
            <p class="text-slate-400">
